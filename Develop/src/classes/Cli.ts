  ...
  findVehicleToTow(Truck: Truck): void {
    inquirer
      ...
      .then((answers) => {
        ...
        const { make, model } = answers.vehicleToTow;
        if(answers.vehicleToTow === Truck) {
          console.log(`Well your ${make} ${model} can't tow itself!`);
          this.performActions();
        } 
         else if (answers.vehicleToTow instanceof Motorbike || answers.vehicleToTow instanceof Car) {
          console.log(`Your ${make} ${model} has been towed.`);
      ...
      .then((answers) => {
        ...
        if (answers.action === 'Print details') {
          ...
          if (selectedVehicle instanceof Truck) {
            const truck = selectedVehicle as Truck;
            this.findVehicleToTow(selectedVehicle);
            return;
        } else {
              console.log("Towing can only be done with trucks");
            }
          }
